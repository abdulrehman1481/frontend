...
export default function PsychologicalInsight() {
  ...
  // Mock psychological status data
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.noteCard}>
          <Text style={styles.noteTitle}>1. User need to fill sets of Psychological Questioners.</Text>
          <Text style={styles.noteText}>For now just create bottom for each</Text>
        </View>

        {/* Questionnaire Form Section */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Questioner form</Text>
        ...
        {/* Note 2 */}
        <View style={styles.noteCard}>
          <Text style={styles.noteTitle}>2. Psychological Status will be Prepared once the above, Questioners are answered.</Text>
        </View>
        ...
        {allCompleted ? (
          ...
          <View style={styles.lockedSection}>
            ...
            <Text style={styles.lockedText}>Complete all questionnaires to view Psychological Status</Text>
          </View>
        )}

        {/* Note 3 */}
        <View style={styles.noteCard}>
          <Text style={styles.noteTitle}>3. The Stress Daily Insight is Calculated based on the Physiological and Psychological Measures</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.timelineCard}>
            ...
            <View style={styles.timelineLabels}>
              <Text style={styles.timelineLabel}>00</Text>
              <Text style={styles.timelineLabel}>06</Text>
              <Text style={styles.timelineLabel}>12</Text>
              <Text style={styles.timelineLabel}>18</Text>
              <Text style={styles.timelineLabel}>24</Text>
            </View>
            <View style={styles.timelineLegend}>
              ...
              <View style={styles.legendItem}>
                ...
                <Text style={styles.legendText}>Anger</Text>
              </View>
              <View style={styles.legendItem}>
              ...
              <View style={styles.legendItem}>
                ...
                <Text style={styles.legendText}>Unimeasurable</Text>
              </View>
            </View>
          </View>
            ...
            <View style={styles.metricsContainer}>
              {stressMetrics.map((metric, index) => (
                <View key={index} style={styles.metricRow}>
                  ...
                  <Text style={styles.metricValue}>{metric.value}/{metric.max}</Text>
        ...
        {/* Old Insights Section - Keep for reference */}
        <View style={styles.section}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.entryCard}>
            <Text style={styles.entryDate}>Yesterday, 8:30 PM</Text>
            <Text style={styles.entryText}>Feeling positive and energized after today's session...</Text>
          </View>
          <View style={styles.entryCard}>
            <Text style={styles.entryDate}>2 days ago, 7:15 PM</Text>
            <Text style={styles.entryText}>Made good progress on stress management techniques...</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.recommendationCard}>
            ...
            <View style={styles.recommendationContent}>
              <Text style={styles.recommendationTitle}>Try Mindfulness Meditation</Text>
              <Text style={styles.recommendationText}>
                Based on your recent data, 10 minutes of daily meditation could help improve your mood
                stability.
              </Text>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  questionnaireFullNameCompleted: {
    color: '#047857',
  },
  checkmarkBadge: {
    position: 'absolute',
