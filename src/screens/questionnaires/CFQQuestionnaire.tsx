...
const CFQ_ITEMS: CFQItem[] = [
  ...
  { id: 18, text: 'Do you find you accidentally throw away the thing you want and keep what you meant to throw away – as in the example of throwing away the matchbox and putting the used match in your pocket?' },
...
export default function CFQQuestionnaire({ navigation }: any) {
  ...
  const getScoreInterpretation = (score: number) => {
    // Higher scores indicate more cognitive failures
    if (score <= 25) {
      return {
        level: 'Low Cognitive Failures',
        color: '#10b981',
        description: 'You experience relatively few cognitive failures in daily life.',
      };
    } else if (score <= 50) {
      return {
        level: 'Moderate Cognitive Failures',
        color: '#f59e0b',
        description: 'You experience a moderate level of cognitive failures. This is common for many people.',
      };
    } else if (score <= 75) {
      return {
        level: 'High Cognitive Failures',
        color: '#ef4444',
        description: 'You experience frequent cognitive failures. Consider stress management or organizational strategies.',
      };
    } else {
      return {
        level: 'Very High Cognitive Failures',
        color: '#dc2626',
        description: 'You experience very frequent cognitive failures. Consider discussing this with a healthcare professional.',
      };
    }
  };

  const isComplete = () => {
    return Object.keys(responses).length === CFQ_ITEMS.length;
  };
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.aboutCard}>
          ...
          <Text style={styles.aboutText}>
            ...
            but some of which happen more often than others. Please indicate how often these things 
            have happened to you in the <Text style={styles.boldText}>past 6 months</Text>.
          </Text>
        </View>
        ...
        <View style={styles.progressCard}>
          <Text style={styles.progressText}>
            Progress: {Object.keys(responses).length} / {CFQ_ITEMS.length}
          </Text>
          <View style={styles.progressBar}>
            <View 
              style={[
                styles.progressFill, 
                { width: `${(Object.keys(responses).length / CFQ_ITEMS.length) * 100}%` }
              ]} 
            />
          </View>
        </View>
        ...
        <View style={styles.referenceCard}>
          <Text style={styles.referenceText}>
            Reference: Broadbent, D.E., Cooper, P.F., FitzGerald, P., & Parkes, K.R. (1982). 
