  ...
  const getScoreInterpretation = (score: number) => {
    if (score <= 21) {
      return {
        level: 'Low Anxiety',
        color: '#10b981',
        description: 'Your anxiety levels are within the normal range.',
      };
    } else if (score <= 35) {
      return {
        level: 'Moderate Anxiety',
        color: '#f59e0b',
        description: 'You are experiencing moderate levels of anxiety. Consider stress management techniques.',
      };
    } else {
      return {
        level: 'Potentially Concerning Anxiety',
        color: '#ef4444',
        description: 'Your anxiety levels may be concerning. Consider consulting with a healthcare professional.',
      };
    }
  };

  const isComplete = () => {
    return Object.keys(responses).length === BAI_ITEMS.length;
  };
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.aboutCard}>
          ...
          <Text style={styles.aboutText}>
            This scale is a self-report measure of anxiety with 21 items. Please carefully read each item 
            in the list and indicate how much you have been bothered by that symptom during the{' '}
        ...
        <View style={styles.progressCard}>
          <Text style={styles.progressText}>
            Progress: {Object.keys(responses).length} / {BAI_ITEMS.length}
          </Text>
          <View style={styles.progressBar}>
            <View 
              style={[
                styles.progressFill, 
                { width: `${(Object.keys(responses).length / BAI_ITEMS.length) * 100}%` }
              ]} 
            />
          </View>
        </View>
        ...
        <View style={styles.scoringCard}>
          ...
          <View style={styles.scoringItem}>
            ...
            <Text style={styles.scoringText}>0-21: Low anxiety</Text>
          </View>
          <View style={styles.scoringItem}>
            <View style={[styles.scoringDot, { backgroundColor: '#f59e0b' }]} />
            <Text style={styles.scoringText}>22-35: Moderate anxiety</Text>
          </View>
          <View style={styles.scoringItem}>
            <View style={[styles.scoringDot, { backgroundColor: '#ef4444' }]} />
            <Text style={styles.scoringText}>36+: Potentially concerning levels of anxiety</Text>
          </View>
        </View>
